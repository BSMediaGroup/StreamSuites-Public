...
- Follow-up: corrected the Public-shell brand icon to `assets/logos/ssmainlogosq.webp` and reduced the Tektur StreamSuites™ title from weight 900 to weight 800 so it remains bold without reading as extra-heavy. The landing `wmnew.webp` wordmark and prior shell/navigation fixes remain unchanged.
