...
test("public leaderboards route hydrates from authoritative progression API", () => {
  ...
  assert.match(app, /Global remains the default\. Channel scoped views show XP\/rank earned inside a creator\/channel context\./);
  ...
  assert.match(css, /\.progression-leaderboard-scope-label/);
