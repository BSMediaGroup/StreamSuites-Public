...
test("public profile owner editor stays runtime-backed and uses canonical social assets", () => {
  ...
  assert.match(app, /profile-link-current-list/);
  assert.match(app, /profile-link-add-menu/);
  assert.match(app, /data-profile-social-add/);
  ...
  assert.match(app, /function applyStandaloneProfileRootTone\(value\)/);
  assert.match(app, /applyStandaloneProfileRootTheme\(profileTheme\)/);
  assert.match(app, /applyStandaloneProfileRootTone\(profileTone\)/);
  ...
  assert.match(app, /document\.body\.dataset\.profileTone = tone/);
  ...
  assert.match(app, /Tone \/ mode/);
  assert.match(profileCss, /data-profile-tone="light"/);
  ...
  assert.match(profileCss, /\.profile-link-current-list/);
