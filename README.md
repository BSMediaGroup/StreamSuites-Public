...
- `/community/my-data.html` now reads the signed-in user’s real public XP/rank progression from `/api/public/progression/me` plus public-authority request history from the authoritative `/api/public/authority/requests/mine` contract.
