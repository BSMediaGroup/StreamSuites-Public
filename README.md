...
- The latest local profile/editor evidence is retained under `output/playwright/`, including `profile-tone-dark-desktop.png`, `profile-tone-light-desktop.png`, `profile-tone-light-mobile.png`, `profile-tone-owner-dropdown-light.png`, `profile-tone-editor-dark.png`, `profile-tone-editor-light.png`, `profile-tone-editor-light-mobile.png`, the theme/framing captures, and `profile-media-polish/owner-editor-social-defined-1060x640.png`, `profile-media-polish/owner-editor-social-add-menu-detail.png`, `profile-media-polish/owner-editor-social-custom-link-1060x640.png`, and `profile-media-polish/owner-editor-social-custom-link-390x844.png`. These are deterministic browser-validation artifacts, not deployed profile content or live-provider acceptance.
