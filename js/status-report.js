  ...
  class CanvasReportWriter {
    ...
    heading(kicker, title, copy = "") {
      ...
      if (copy) {
        ...
        context.font = '22px "Blinker", sans-serif';
    ...
    drawComponentCard(component, x, y, width, height) {
      ...
      context.fillStyle = "#95a6b4";
      context.font = '17px "Blinker", sans-serif';
    ...
    operations(title, records, emptyCopy) {
      ...
      if (!records.length) {
        ...
        this.context.font = '21px "Blinker", sans-serif';
      ...
      records.forEach((item) => {
        ...
        this.context.font = '18px "Blinker", sans-serif';
